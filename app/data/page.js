            ...
            <div
                className={
                    ...
                    (isCorrectionDialogOpen
                        ? " blur md:blur-none md:grayscale"
                        : "")
                }
            >
                        ...
                        <div className="flex flex-row flex-wrap justify-between gap-2">
                            <div className="flex flex-col gap-2 w-full md:w-auto">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setFilterNeedForPickup(e.target.value)
                                    }
                                >
                                    <option value="">All</option>
                        ...
                        <div className="flex flex-row flex-wrap justify-between gap-2">
                            <div className="flex flex-col gap-2 w-full md:w-auto">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setFilterNeedForDrop(e.target.value)
                                    }
                                >
                                    <option value="">All</option>
                                    <option value="Yes">Yes</option>
                            ...
                            <div className="flex flex-col justify-between gap-2 w-full md:w-auto">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setFilterModeOfTravelForDrop(
                                            e.target.value,
                                        )
                                    }
                                >
                                    <option value="">All</option>
                                    {modeOfTravelForDropOptions.map(
                                        (mode, index) => (
                                            <option key={index} value={mode}>
                                                {mode}
                                            </option>
                        ...
                        <div className="flex flex-col md:flex-row flex-wrap justify-between gap-2">
                            ...
                            <div className="flex flex-col gap-2 w-full md:w-auto">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setFilterCheckInDate(e.target.value)
                                    }
                                >
                                    <option value="">All</option>
                            ...
                            <div className="flex flex-col gap-2 w-full md:w-auto">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setFilterCheckOutDate(e.target.value)
                                    }
                                >
                                    <option value="">All</option>
                                ...
                                <p className="text-4xl font-bold">
                                    {filteredData.reduce(
                                        (acc, row) =>
                                            acc +
                                            parseInt(
                                                row.numNonParticipatingSiblings ??
                                                    0,
                                            ),
                                        0,
                                    )}
                        ...
                        >
                            ...
                            <div className="mt-2 px-3 pb-4">
                                ...
                                row.correctionRequest.rc ? (
                                    ...
                                    >
                                        Request Correction in Accomodation
                                        Details
                                    </button>
                                )}
                            </div>
                            ...
                            >
                                {dialogType === "sd" && (
                                    <>
                                        <div className="px-4 pt-2">
                                            ...
                                            <p className="text-xs mt-2">
                                                DOJ BV:{" "}
                                                {correctionData.dateOfJoiningBalvikas ??
                                                    "-"}{" "}
                                        ...
                                        <div className="flex flex-wrap gap-1 px-3">
                                            ...
                                            {correctionData.registeredEvents.map(
                                                (event, index) => (
                                                    <p
                                                        key={index}
                                                        className="text-xs bg-green-200 text-green-800 font-bold rounded-xl p-1 px-2 w-fit"
                                ...
                                {dialogType === "ac" && (
                                    <div className="py-2">
                                        ...
                                        <p className="px-4 text-xs">
                                            {correctionData.hasAccompanyingAdults ===
                                            "Yes"
                                                ? "Has Accompanying adults."
                                                : "No Accompany."}
                                        </p>
                                        <div className="mt-2 mx-3 bg-gray-50 p-2 rounded-2xl">
                                            ...
                                            <p className="text-xs">
                                                {correctionData.accompanyingPersonGender ??
                                                    "-"}{" "}
                                                -{" "}
                                                {correctionData.accompanyingPersonAge ??
                                                    "-"}{" "}
                                                yrs
                                            </p>
                                            <p className="text-xs">
                                            ...
                                            <div className="flex gap-1 mt-2">
                                                <p className="text-xs bg-blue-200 text-blue-800 font-bold rounded-xl p-1 px-2 w-fit">
                                                    {correctionData.numMaleAccompanying ??
                                                        "0"}{" "}
                                                    male
                                                </p>
                                                <p className="text-xs bg-blue-200 text-blue-800 font-bold rounded-xl p-1 px-2 w-fit">
                                                    {correctionData.numFemaleAccompanying ??
                                                        "0"}{" "}
                                                    female
                                                </p>
                                                <p className="text-xs bg-blue-200 text-blue-800 font-bold rounded-xl p-1 px-2 w-fit">
                                                    {correctionData.numNonParticipatingSiblings ??
                                                        "0"}{" "}
                                                    children
                                                </p>
                                            </div>
