...
export default function Grp3Step2 ({previousStep,nextStep})
{
    ...
    const validateForms = () =>{
        ...
        if ((grp3Data.event1 === "Drawing" && grp3Data.quiz === "Yes") || (grp3Data.event2 === "Drawing" && grp3Data.quiz === "Yes")){
            errors.quiz = "Student cannot participate in both Quiz and Drawing at the same time";
            alert("Student cannot participate in both Quiz and Drawing at the same time");
        }
        if ((grp3Data.event1.startsWith("Tamizh Chants") && grp3Data.event2.startsWith("Bhajans")) || (grp3Data.event1.startsWith("Bhajans") && grp3Data.event2.startsWith("Tamizh Chants"))){
        ...
        if (grp3Data.event1.startsWith("GROUP") && grp3Data.quiz === "Yes"){
            errors.quiz = "Student cannot participate in Quiz and Group Events at the same time";
            alert("Student cannot participate in Quiz and Group Events at the same time");
        }
                ...
                <form onSubmit={handleSubmit}>
                    <div className="rounded-2xl p-6 mt-8 mb-8 w-11/12 sm:w-8/12 mx-auto bg-gray-200 shadow-lg border border-gray-300 overflow-x-auto flex flex-col gap-4 md:gap-0">
                        ...
                        <div className="rounded-2xl p-6 mt-8 w-full sm:w-10/12 mx-auto bg-gray-100 shadow-lg border border-gray-300 overflow-x-auto flex flex-col gap-5 md:gap-0">
                            <h2 className="text-xl text-black text-left">Has the student passed Group 2 examination?</h2>
                            <div className="flex flex-col gap-2">
                                <label className="flex items-center gap-2">
                                    <input type="radio" name="pass" value="Yes" onChange={handleChange} required className="w-4 h-4 mt-2" />
                                    <span className="text-xl text-gray-700 mt-2">Yes</span>
                                </label>

                                <label className="flex items-center gap-2">
                                    <input type="radio" name="pass" value="No" onChange={handleChange} className="w-4 h-4" />
                                    <span className="text-xl text-gray-700">No</span>
                                </label>

                                {grp3Error.pass && <span className="text-red-500 text-sm">{grp3Error.pass}</span>}
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl p-6 mt-8 w-full sm:w-10/12 mx-auto bg-gray-100 shadow-lg border border-gray-300 overflow-x-auto flex flex-col gap-5 md:gap-0">
                            ...
                            <div className="flex flex-col gap-2">
                                <select name="event1" value={grp3Data.event1} onChange={handleChange} required className="text-xl text-gray-700 border border-gray-500 p-4 mt-2 rounded-2xl w-full sm:w-auto">
                                ...
                                {grp3Error.event1 && <span className="text-red-500 text-sm">{grp3Error.event1}</span>}
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl p-6 mt-8 w-full sm:w-10/12 mx-auto bg-gray-100 shadow-lg border border-gray-300 overflow-x-auto flex flex-col gap-5 md:gap-0">
                            ...
                            <div className="flex flex-col gap-2">
                                <select name="event2" value={grp3Data.event2} onChange={handleChange} className="text-xl text-gray-700 border border-gray-500 p-4 mt-2 rounded-2xl w-full sm:w-auto">
                                    <option value="" disabled>Select an event</option>
                                    <option value="Bhajans - Boys">Bhajans - Boys</option>
                                    <option value="Bhajans - Girls">Bhajans - Girls</option>
                                    <option value="Slokas - Boys">Slokas - Boys</option>
                                ...
                                {grp3Error.event2 && <span className="text-red-500 text-sm">{grp3Error.event2}</span>}
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl p-6 mt-8 w-full sm:w-10/12 mx-auto bg-gray-100 shadow-lg border border-gray-300 overflow-x-auto flex flex-col gap-5 md:gap-0">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {grp3Error.quiz && <span className="text-red-500 text-sm">{grp3Error.quiz}</span>}
                            </div>
                        </div>
